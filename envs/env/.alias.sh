...
{ # git
  alias fast_gcl='git clone'
  alias fast_gp='git pull'
  alias fast_gf='git fetch'
  alias fast_go='git checkout'
  alias fast_gs='git status'
  alias fast_ga='git add'
  alias fast_gb='git branch'
  alias fast_gc='git commit'
  alias fast_gd='git diff'
  alias fast_gl='git log'
  alias fast_gm='git merge'
  alias fast_gr='git rebase'
  alias fast_grc='git rebase --continue'
  alias fast_grs='git rebase --skip'
  alias fast_gra='git rebase --abort'
  alias fast_gcp='git cherry-pick'
  alias fast_prune='git gc --prune=now'
}
...
{ # workspace
  ...
  alias ws_ollama_codex='cd $HOME/ai/codex && ollama_codex'
  alias ws_ollama_openclaw='cd $HOME/ai/openclaw && ollama_openclaw'
}
